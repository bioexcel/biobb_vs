...
htmlhelp_basename = 'biobb_vs_doc'
...
latex_documents = [
    (master_doc, 'biobb_vs.tex', u'biobb_vs Documentation',
...
man_pages = [
    (master_doc, 'biobb_vs', u'biobb_vs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'biobb_vs', u'biobb_vs Documentation',
     author, 'biobb_vs', 'biobb_vs molecular dynamics ml building blocks',
     'Miscellaneous'),
]
