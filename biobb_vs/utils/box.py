...
class Box():
    ...
    Args:
        input_pdb_path (str): PDB protein structure for which the box will be build. Its size and center will be set around the 'resid_pdb_path' residues once mapped against this PDB. `Sample file <>`_. Accepted formats: pdb.
        resid_pdb_path (str): PDB file containing a selection of residue numbers mappable to 'input_pdb_path'. `Sample file <>`_. Accepted formats: pdb.
        output_pdb_path (str): PDB protein structure coordinates including the annotation of the box center and size as REMARKs. `Sample file <>`_. Accepted formats: pdb.
        properties (dic):
